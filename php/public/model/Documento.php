<?php
/**
 * Classe de gerenciamento da tabela "documento", serve de modelo para replicar e gerenciar outras tabelas
 *
 * @category REST_API
...
class Documento extends Collection
{
    /**
     * Nome da tabela do banco de dados que esta classe irá gerenciar
     */
    private $collection_name = 'documento';
    ...
    protected function create_table() {
        ...
        try {
            ...
            $sqlcmd =
                ...
                . ") COMMENT 'Cadastro de Dados de Documentos de Pessoas';"
                ."CREATE UNIQUE INDEX documento_id_uindex ON documento (id);";
